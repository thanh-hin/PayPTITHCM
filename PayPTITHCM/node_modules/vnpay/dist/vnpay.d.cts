import { DefaultConfig, Bank, BuildPaymentUrlLogger, BuildPaymentUrl, BuildPaymentUrlOptions, GenerateQrResponseLogger, GenerateQrResponseOptions, GenerateQrResponse, VerifyReturnUrlLogger, ReturnQueryFromVNPay, VerifyReturnUrlOptions, VerifyReturnUrl, VerifyIpnCallLogger, VerifyIpnCallOptions, VerifyIpnCall, QueryDrResponseLogger, QueryDr, QueryDrResponseOptions, QueryDrResponse, RefundResponseLogger, Refund, RefundOptions, RefundResponse } from './types.cjs';
...
declare class VNPay {
     ...
     */
    generateQr<LoggerFields extends keyof GenerateQrResponseLogger>(data: BuildPaymentUrl, options?: GenerateQrResponseOptions<LoggerFields>): Promise<GenerateQrResponse>;
    /**
